...
const
  ...
  Lape_Keywords: array[0..46 {$IFDEF Lape_PascalLabels}+1{$ENDIF} {$IFDEF Lape_NativeKeyword}+1{$ENDIF}] of TLapeKeyword = (
  ...
  OperatorAssociative: array[EOperator] of EOperatorAssociative = (
    ...
    assocRight,                         //op_MinusAsgn 
    assocRight,                         //op_MulAsgn 
    assocRight,                         //op_PlusAsgn 
    assocRight,                         //op_PowAsgn (}..)
    assocLeft,                          //op_Deref
    assocLeft,                          //op_DIV
    assocLeft,                          //op_Divide
    assocLeft,                          //op_Dot
